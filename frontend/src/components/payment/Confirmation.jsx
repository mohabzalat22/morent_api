function Confirmation() {
  return (
    <div className="bg-white p-4 rounded-lg">
      <h3 className="text-gray-800 font-semibold text-xl">Confirmation</h3>
      <div className="flex justify-between">
        <h4 className="text-gray-500 text-sm">
          We are getting to the end. Just few clicks and your rental is ready!
        </h4>
        <h4 className="text-gray-500 text-sm">Step 4 of 4</h4>
      </div>
      <div className="py-2">
        <div className="flex items-center bg-gray-100 p-4 rounded-md my-2 px-8">
          <input type="checkbox" className="w-4 h-4" id="marketing" />
          <label
            htmlFor="marketing"
            className="text-base text-gray-700 font-bold ms-4"
          >
      ...
      <div className="my-4">
        <button className="rounded-md px-6 py-4 bg-blue-600 text-white font-semibold">
          Rent Now
        </button>
        <div className="my-10">
          <svg
